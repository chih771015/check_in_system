...
**備案** — 如果覺得太複雜：取消 Excel 多病人支援，每列只能一個病人 → 一個排班一個病人，想多病人就用網頁 UI。

> **❓ 待你裁示**：採用扁平化方案，還是簡化為「Excel 只支援單病人」？
...
### 5.5 補打卡（Makeup）— Q8-2 提案

**待你裁示，三個方案：**

#### 方案 A：補打卡完全不處理病人（最寬鬆）
- 補打卡只是補一個「我來過」的紀錄，跟病人診斷流程脫鉤
- 病人狀態由 admin 在事後手動補登（admin 新增「上傳診斷證明」功能）
- 優點：流程簡單，翻譯員無壓力
- 缺點：admin 工作量大；診斷證明可能根本沒上傳

#### 方案 B：補打卡時允許上傳，但不強制（中庸）⭐
- 補打卡頁面也顯示病人清單，可選擇上傳/標記未到，但都是**選填**
- 沒處理的病人保持 pending，admin 後台可看到提示
- 補打卡仍需強制填「補打卡原因」（現狀）
- 優點：流程彈性，事後仍有機會記錄
- 缺點：可能留下未處理的病人，需要 admin 介入收尾

#### 方案 C：補打卡強制處理所有病人（最嚴格）
- 補打卡時必須上傳每個病人診斷證明或標記未到，才能完成補打卡
- 優點：資料完整
- 缺點：翻譯員若照片遺失就卡死無法補打卡
...
1. **Excel 匯入格式**（4.4）— 扁平化 vs 簡化為單病人？
2. **補打卡與病人流程**（5.5）— 方案 A / B / C？
